...
| search_availability | store_id、service_id、time_window、resource_preferences、limit；reschedule_target_id? | candidates[]：candidate_ref（不透明引用）、资源单元展示引用、start/end、约束说明、dependency_versions、reason_codes、score_breakdown、ranking_version；snapshot_at、guarantee=NONE。候选引用不能当占位凭据 |
